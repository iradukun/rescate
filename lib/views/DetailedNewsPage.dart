...
import 'package:response/views/HomePage.dart';
                    ...
                    FloatingActionButton(
                      ...
                      onPressed: () {
                        ShareFunction.Share.share(
                            "${widget.distype} Alert⚠️️ ${widget.headline}❗Visit the news link: ${widget.url} Do a good thing today😇 Donate to ${widget.distype} Relief funds: https://pmnrf.gov.in/en/online-donation",
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ' Yesterday, 9:24 PM • ${widget.location}',
